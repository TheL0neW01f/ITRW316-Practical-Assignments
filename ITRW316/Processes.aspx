...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <section style="height: 735px; width: 898px;">
                <h1>Processes</h1>
            ...
            <h2>Enter running time for process 2:</h2>
                <p>
                    <asp:TextBox ID="txtRun2" runat="server"></asp:TextBox>
                </p>
            <h2>Enter arrival time for process 3:</h2>
                <p>
                    <asp:TextBox ID="txtArr3" runat="server"></asp:TextBox>
                </p>
            <h2>Enter running time for process 3:</h2>
                <p>
                    <asp:TextBox ID="txtRun3" runat="server"></asp:TextBox>
                </p>
            <h2>Enter arrival time for process 4:</h2>
                <p>
                    <asp:TextBox ID="txtArr4" runat="server"></asp:TextBox>
                </p>
            <h2>Enter running time for process 4:</h2>
                <asp:TextBox ID="txtRun4" runat="server" Height="16px"></asp:TextBox>
            <br />
                <br />
            <br />
                 <asp:Button BackColor="SkyBlue" Font-Size="Large" BorderStyle="Solid" BorderColor="PowderBlue" ForeColor="Black" ID="Button1" runat="server" Text="Next Page" OnClick="Button1_Click" />
                 </section>
        </div>
    </form>
</body>
